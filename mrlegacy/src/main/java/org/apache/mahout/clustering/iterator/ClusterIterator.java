 ...
 * prior ClusterClassifier which has been initialized with a set of models. Its
 * implementation is algorithm-neutral and works for any iterative clustering
 * algorithm (currently k-means and fuzzy-k-means) that processes all the input
 * vectors in each iteration. The cluster classifier is configured with a
 * ClusteringPolicy to select the desired clustering algorithm.
 */
public final class ClusterIterator {
    ...
    /**
     * Iterate over data using a prior-trained ClusterClassifier, for a number
     * of iterations using a sequential implementation
     * 
     * @param conf
     *            the Configuration
     * @param inPath
